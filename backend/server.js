...
// Database setup endpoint (TEMPORARY - for initial setup only)
    ...
    try {
        ...
        res.json({
            ...
            users: [
                ...
                'Level 1 (عيسى العنزي): 20001 / password123',
                'Level 2 (مشعل سعود الزمنان): 30001 / password123',
                'Level 3 (Eng. صادق): 40001 / password123'
            ]
        });
    } catch (error) {
